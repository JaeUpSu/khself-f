...
export const SkillModal = ({ icon, gauge, isOpen, onClose }: Props) => {
  const lgIconSize = 80;
          ...
          <VStack my="10">
            ...
            >
              ...
              <Text mt="2">
                ...
                최적화하기 위해 사용합니다. <br />
                <br /> Next.js 13 버전에서 사용되는 App 라우터등과 같은 기술들은
                구글링을 통한 참고 자료가 많지 않아 호환과 러닝커브가 높은 문제
                때문에 기존에 사용하던 Pages 라우팅을 통해 SSR 과 SSG 등과 같은
                기술을 사용하며 학습하고 있습니다.
              </Text>
            </Box>
          </VStack>
